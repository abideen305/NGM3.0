      ...
      <div className="relative bg-[#FCFCFD] flex items-center justify-center p-20 sm:p-6">
        ...
        <div className="flex flex-col gap-20 sm:gap-6 ">
            ...
            <div className="flex gap-10 sm:flex-col sm:gap-6 ">
                <div className=" border-2 border-[#E3E8EF] rounded-xl px-4 py-6 flex flex-col gap-3 ">
                    <h4 className='text-[#202939] font-medium ' >Networking Mixer</h4>
                    <p className='text-[#697586] ' >This year we are making it possible to
                      engage in insightful conversations and forge valuable connections at
                      the NGM Conference 3.0
</p>
                </div>
                <div className="bg-[#fff] border-2 border-[#E3E8EF] rounded-xl px-4 py-6 flex flex-col gap-3 ">
                    <h4 className='text-[#202939] font-medium ' >Team-building Exercises</h4>
                    <p className='text-[#697586] ' >Get ready to enhance collaboration through our dynamic team-building 
                        exercises designed to foster synergy among participants.</p>
                </div>
                <div className="bg-white  border-2 border-[#E3E8EF] rounded-xl px-4 py-6 flex flex-col gap-3 ">
                    <h4 className='text-[#202939] font-medium ' >Startup Pitch</h4>
                    <p className='text-[#697586] ' >Be a witness as innovative minds take the startup stage
